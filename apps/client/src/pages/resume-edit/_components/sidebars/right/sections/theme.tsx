    ...
    <section id="theme" className="grid gap-y-6">
      <header className="flex items-center justify-between">
        <div className="flex items-center gap-x-4">
          ...
          <h2 className="text-2xl font-bold line-clamp-1">{t`侧边栏主题`}</h2>
        </div>
      </header>
      ...
      <main className="grid gap-y-4">
        ...
        <div className="space-y-1.5">
          <Label htmlFor="theme.primary">{t`侧边栏背景色`}</Label>
        ...
        <div className="space-y-1.5">
          <Label htmlFor="theme.primary">{t`侧边栏字体颜色`}</Label>
          <div className="relative">
            <Popover>
              <PopoverTrigger asChild>
                <div
              ...
              <PopoverContent asChild className="p-0 bg-transparent border-none rounded-lg">
                <HexColorPicker
